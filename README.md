...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wjnrb9u.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wjnrb9u.containers.anotherwebservice.com/
...
```
git clone git@github.com:alxnko/container-wjnrb9u.git
cd container-wjnrb9u
```
...
```
docker attach container-wjnrb9u
```
